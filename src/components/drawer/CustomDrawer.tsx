    ...
    >
      ...
      <List sx={{ transform: 'none' }}>
        <Link href="/dashboard" passHref>
          <ListItem component="a" sx={getListStyle('/dashboard')}>
            <ListItemIcon>
        ...
        <Link href="/" passHref>
          <ListItem component="a" sx={getListStyle('/')}>
            <ListItemIcon>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Box
                style={{ padding: '0.3rem 1rem', border: '1px solid #E5E8EC', borderRadius: 5, marginRight: '0.3rem' }}
              >
              ...
              <IconButton color="inherit" onClick={popperHandler} style={{ margin: '0 .1rem' }}>
      ...
      <Box
        ...
        sx={{
          ...
          minHeight: '100vh',
          overflow: 'auto',
          background: 'radial-gradient(circle, rgba(226,226,226,0.43666434356) 0%, rgba(255,255,255,0.5) 100%)',
        }}
      >
        <Toolbar />
        <main>{children}</main>
