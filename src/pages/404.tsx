    ...
    <>
      ...
      <div className={classes.container}>
        <div className={classes.left_section}>
          <div className={classes.inner_content}>
            ...
            <p className={classes.subheading}>
              ...
              {authenticated ? 'silahkan kembali ke halaman sebelumnya' : 'silahkan login terlebih dahulu'}
            </p>
            <div
              style={{
                display: 'flex',
        ...
        <div className={classes.right_section}>
          <svg className={classes.svgimg} xmlns="http://www.w3.org/2000/svg" viewBox="51.5 -15.288 385 505.565">
          ...
          c0-1.534,1.244-2.778,2.778-2.778h13.889c1.534,0,2.778,1.244,2.778,2.778V93.75z"
              ...
              <circle className={classes.lamp_light} cx="119.676" cy="44.22" r="40.51" />
              <path
                className={classes.lamp_details}
          ...
          S149.306,67.362,149.306,71.528z"
              ...
              >
                ...
                <stop offset="50%" style={{ stopColor: '#EDEDED', stopOpacity: 0.5 }}>
                  <animate attributeName="stop_opacity" values="0.0; 0.5; 0.0" dur="5000ms" repeatCount="indefinite" />
                </stop>
                <stop offset="100%" style={{ stopColor: '#EDEDED', stopOpacity: 0 }} />
              </radialGradient>
              <circle className={classes.lamp_light__glow} fill="url(#SVGID_1_)" cx="119.676" cy="44.22" r="65" />
              <path
